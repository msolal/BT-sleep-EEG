...
ax1.set_ylabel('Loss')
ax1.figure.savefig('plots/pb4-mass-learning-curve-1')
ax2 = history_df.plot(x='epoch', y=['train_perf', 'valid_perf'], marker='o')
ax2.set_ylabel('Cohen\'s kappa')
ax2.figure.savefig('plots/pb4-mass-learning-curve-2')
...
plot_confusion_matrix(conf_mat, classes_mapping).savefig('plots/pb5-mass-confusion-matrix')
...
ax.legend()
ax.figure.savefig('plots/pb6-mass-hypnogram')
